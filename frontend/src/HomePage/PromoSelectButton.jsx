...
class PromoSelectButton extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit = values => {
        ...
        this.order.promoId = values.promo || null
                ...
                >
                    ...
                    <DialogContent>
                        <SimpleForm
                            ...
                            toolbar={null}
                        >
                            <ReferenceInput label="Promo" source="promo" reference="promo" allowEmpty>
